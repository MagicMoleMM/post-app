...
import SearchPanel from "../search-panel/seach_panel";
...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            data: [
                {label: "Новый интересный пост", important: false, like: false, id: 1},
                {label: "Going to learn React", important: false, like: false, id: 2},
                {label: "That is so good!", important: true, like: false, id: 3},
